...
%\title{Ceci est un titre sur plusieurs lignes mais avec un titre assez long pour voir ce que ça fait}
%\author{Karnaj, Clem, AmarOk, pierre-24, Arius, Eskimon, vhf, GCodeur, artragis, gustavi, Emeric, Yugo}
